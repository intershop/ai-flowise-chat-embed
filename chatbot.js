import Chatbot from "https://cdn.jsdelivr.net/gh/intershop/ai-flowise-chat-embed@website/intershop/dist/web.js"
    Chatbot.init({
        ...
        chatWindow: {
            ...
            welcomeMessage: 'Hi there! I’m your Intershop Copilot – here to help with all your questions about our e-commerce solutions. How can I assist you today?',//'Your conversations with the Intershop Copilot chatbot may be processed to improve our services and enhance your experience. Please note that while the data from your interactions may be analyzed, it will not be associated with any identifiable individuals. All data is handled in compliance with applicable privacy regulations to ensure the protection of your personal information.',   
            errorMessage: 'sry something went wrong...',
            backgroundColor: '#f5f5f5',
            height: 700,
            width: 400,
            fontSize: "16px",
            starterPrompts: ['How can Intershop help grow my \nonline business?', 'What features does Intershop offer \nfor B2B companies?', 'Can you share success stories \nfrom Intershop customers?', 'Want to learn more about \nIntershop Fall 2025 Release?', 'I’d like to schedule an online demo.'], // It overrides the starter prompts set by the chat flow passed
